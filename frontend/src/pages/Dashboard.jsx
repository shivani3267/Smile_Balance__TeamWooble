...
//                 // Assuming your backend returns { user: { fullName, balance, smiles, streak, ... } }
//                 setUser(data.user); 
//             } catch (err) {
...
//                 <div className="text-xl font-bold text-white animate-pulse">Loading Dashboard...</div>
//             </div>
//         );
//     }

//     // Fallback values in case backend fields are missing
//     const userData = {
//         name: user?.fullName || "User",
//         balance: user?.balance ?? 0,
//         smiles: user?.smiles ?? 0,
//         streak: user?.streak ?? 0,
//         todaySmiles: user?.todaySmiles ?? 0,
//         nextSmileIn: "02h 18m", // Keeping this static for now as per your demo
//     };
...
//                         <Link to="/withdraw" className="hidden md:inline-flex items-center justify-center px-4 py-2 rounded-2xl bg-white/10 border border-white/15 hover:bg-white/15 transition">
//                             Wallet
//                         </Link>
//                         <button
...
//                             <button onClick={() => nav("/smile")} className="px-6 py-4 rounded-2xl bg-gradient-to-r from-yellow-300 to-orange-400 text-black font-extrabold hover:scale-[1.02] transition shadow-xl">
//                                 Give a Smile
//                                 <p className="text-xs font-medium opacity-80 mt-1">Earn +₹10</p>
//                             </button>
//                             <button onClick={() => nav("/withdraw")} className="px-6 py-4 rounded-2xl bg-gradient-to-r from-emerald-300 to-green-400 text-black font-extrabold hover:scale-[1.02] transition shadow-xl">
//                                 Withdraw
...
//                             <button className="text-sm text-gray-300 hover:text-white underline underline-offset-4">View all</button>
//                         </div>
//                         <div className="mt-5 space-y-3">
//                             {activity.map((a, idx) => (
//                                 <div key={idx} className="flex items-center justify-between bg-black/25 border border-white/10 rounded-2xl p-4 hover:bg-black/35 transition">
//                                     <div>
//                                         <p className="font-semibold">{a.title}</p>
//                                         <p className="text-xs text-gray-300 mt-1">{a.time}</p>
//                                     </div>
//                                     <p className={`font-extrabold ${a.amount.startsWith("+") ? "text-green-300" : "text-yellow-200"}`}>{a.amount}</p>
//                                 </div>
//                             ))}
//                         </div>
//                     </div>
...
//                         <p className="text-gray-300 mt-2">Smile twice today and keep the streak alive.</p>
...
//                                 {userData.todaySmiles >= 2 ? "✅ Limit reached!" : `✅ ${2 - userData.todaySmiles} smile left today`}
//                             </p>
//                         </div>
//                         <button onClick={() => nav("/smile")} className="mt-6 w-full py-4 rounded-2xl bg-white text-black font-extrabold hover:scale-[1.02] transition">
//                             Start AI Scan ✨
//                         </button>
//                     </div>
//                 </div>
