...
export default function Smile() {
  ...
  // ✅ base64 upload (FaceAPI reliable)
  const onUpload = (e) => {
    const file = e.target.files?.[0];
    if (!file) return;
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-300 mt-2 text-sm max-w-xl">
              Capture a selfie using camera or upload. AI checks expressions and verifies reward.
            </p>
          </div>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-white/10 backdrop-blur-2xl border border-white/15 rounded-3xl p-6">
            ...
            <p className="mt-4 text-xs text-gray-400">
              Models load from CDN (needs internet). Rewards update from backend.
            </p>
          </div>
        </div>
      </div>
